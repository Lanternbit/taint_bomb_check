...
public class Jobf_18_Control {
    ...
    public static void main(String[] llllllllllIIlll) throws RunnerException {
        Options llllllllllIIllI = new OptionsBuilder().include(Jobf_18_Control.class.getSimpleName()).threads(llll[2]).forks(llll[1])
                .resultFormat(ResultFormatType.CSV)
                .result( "results\\Control\\JMHSample_18_Control_Jobf.csv").build();
