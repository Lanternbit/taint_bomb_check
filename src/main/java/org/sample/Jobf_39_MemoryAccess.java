...
public class Jobf_39_MemoryAccess {
    ...
    public static void main(String[] lllllllllIlIIII) throws RunnerException {
        Options lllllllllIIllll = new OptionsBuilder().include(String.valueOf(new StringBuilder().append(lll[lIlI[1]]).append(Jobf_39_MemoryAccess.class.getSimpleName()).append(lll[lIlI[2]])))
                .resultFormat(ResultFormatType.CSV)
                .result( "results\\MemoryAccess\\JMHSample_39_MemoryAccess_Jobf.csv").build();
