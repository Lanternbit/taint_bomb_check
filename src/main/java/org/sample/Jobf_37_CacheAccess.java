...
public class Jobf_37_CacheAccess {
    ...
    public static void main(String[] lllllllllIIllll) throws RunnerException {
        Options lllllllllIIlllI = new OptionsBuilder().include(String.valueOf(new StringBuilder().append(lIl[lIlI[1]]).append(Jobf_37_CacheAccess.class.getSimpleName()).append(lIl[lIlI[2]])))
                .resultFormat(ResultFormatType.CSV)
                .result( "results\\CacheAccess\\JMHSample_37_CacheAccess_Jobf.csv").build();
