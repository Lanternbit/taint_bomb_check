...
public class Jobf_21_ConsumeCPU {
    ...
    public static void main(String[] llllllllllIIllI) throws RunnerException {
        new Runner(new OptionsBuilder().include(Jobf_21_ConsumeCPU.class.getSimpleName()).forks(lIIII[0])
                .resultFormat(ResultFormatType.CSV)
                .result( "results\\ConsumeCPU\\JMHSample_21_ConsumeCPU_Jobf.csv").build()).run();
        "".length();
    }
